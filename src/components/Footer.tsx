...
const legal = [
  ...
  { label: "Delivery & Access", path: "/shipping" },
]
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <ul className="space-y-4">
            {legal.map((item) => (
              <li key={item.label}>
                <Link
                  to={item.path}
                  className="text-[15px] text-white/60 hover:text-white hover:translate-x-2 transition-all duration-300 ease-in-out inline-block"
                >
                  {item.label}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center gap-3 text-[15px] text-white/60 group">
              <Phone className="h-5 w-5 text-white/60 group-hover:text-white transition-colors shrink-0" />
              <a
                href="tel:+919119496501"
                className="group-hover:text-white group-hover:translate-x-2 transition-all duration-300 ease-in-out inline-block"
              >
                +91 9119496501
              </a>
            ...
            <li className="flex items-start gap-3 text-[15px] text-white/60">
              ...
              <span>36, Shri Ram Nagar , New Subhedar Layout,<br />Nagpur, Maharashtra — 440024</span>
            </li>
          </ul>
        </div>
